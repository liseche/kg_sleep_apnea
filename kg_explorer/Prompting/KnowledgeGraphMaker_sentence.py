...
- a input file with dataset generated with SENTENCE split strategy.
"""
...
input_file = "../data/ICSD3_sentence.txt"
...
chunk_counter = 723 # counter for the size we're at now
to_line = 2000 # how many total lines from input file to process
ontology = Ontology(
    labels=[
